...
addon._dir = [[Interface\AddOns\UI_Reborn\Extensions\ImprovedUI_ActionBar\assets\]];
addon.config = {
	...
	-- @param: number, boolean
		...
		y_position = 48,									--; multibar not is shown, default position.
		leftbar_offset = 90,								--; multibar left is shown, this pushes bar to up.
		rightbar_offset = 45,								--; multibar right is shown, this pushes bar to up.
		stance = {
			x_position = 1,									--; stancebar x-axis position.
		},
		pet = {
			x_position = 433,								--; petbar x-axis position.
			y_position = 47,								--; petbar x-axis position.
			leftbar_offset = 81,							--; multibar left is shown, this pushes bar to up.
