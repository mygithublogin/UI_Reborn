...
local options = {
    ...
    args = {
        ...
        config = {
            type = 'header',
            name = 'Настройки полосы применения заклинаний',
            order = 100
        },
        scale = {
            type = 'range',
        ...
        x = {
            type = 'range',
            name = 'Позиция X',
            desc = 'Двигайте позлунок чтобы изменить позицию Х' .. getDefaultStr('x'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 102
        ...
        y = {
            type = 'range',
            name = 'Позиция Y',
            desc = 'Двигайте позлунок чтобы изменить позицию Y' .. getDefaultStr('y'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 102
...
function Module.CreateNewCastbar()
    local standardRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarStandard2'
    local borderRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarFrame2'
    local backgroundRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarBackground2'
    local sparkRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarSpark'
    ...
    bgTex:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\MinimapBorder')
...
function Module.SetBarChannel()
    local channelRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarChannel'
...
function Module.SetBarInterrupted()
    local interruptedRef = 'Interface\\AddOns\\UI_Reborn\\Textures\\Castbar\\CastingBarInterrupted2'
