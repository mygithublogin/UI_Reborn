...
local options = {
    ...
    args = {
        ...
        sizeX = {
            type = 'range',
            name = 'Размер X',
            desc = 'Двигайте позлунок чтобы изменить размер X' .. getDefaultStr('sizeX'),
            min = 0,
            max = 1000,
            bigStep = 0.50,
            order = 103
        ...
        sizeY = {
            type = 'range',
            name = 'Размер Y',
            desc = 'Двигайте позлунок чтобы изменить размер Y' .. getDefaultStr('sizeY'),
            min = 0,
            max = 1000,
            bigStep = 0.50,
            order = 103
...
local frame = CreateFrame('FRAME', 'ImprovedUIChatFrame', UIParent)
