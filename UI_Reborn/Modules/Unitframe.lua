...
local optionsPlayer = {
    ...
    args = {
        ...
        classcolor = {
            type = 'toggle',
            name = 'Цвет класса',
            desc = 'Заменить цвет здоровья на цвет класса',
            order = 10.1
        },
        configSize = {
            type = 'header',
        ...
        override = {
            type = 'toggle',
            name = 'Включить',
            desc = 'Включить пользовательскую позицию интерфейса',
            order = 101,
            width = 'full'
        },
        anchor = {
            type = 'select',
            name = 'Якорь',
            desc = '' .. getDefaultStr('anchor', 'player'),
            values = {
                ['TOP'] = 'TOP',
                ['RIGHT'] = 'RIGHT',
                ['BOTTOM'] = 'BOTTOM',
        ...
        anchorParent = {
            type = 'select',
            name = 'Главный якорь',
            desc = 'Главный якорь' .. getDefaultStr('anchorParent', 'player'),
            values = {
                ['TOP'] = 'TOP',
                ['RIGHT'] = 'RIGHT',
                ['BOTTOM'] = 'BOTTOM',
        ...
        x = {
            type = 'range',
            name = 'Позиция X',
            desc = 'Двигайте позлунок чтобы изменить позицию Х' .. getDefaultStr('x', 'player'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 107
        ...
        y = {
            type = 'range',
            name = 'Позиция Y',
            desc = 'Двигайте позлунок чтобы изменить позицию Y' .. getDefaultStr('y', 'player'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 108
...
local optionsTarget = {
    ...
    args = {
        ...
        x = {
            type = 'range',
            name = 'Позиция X',
            desc = 'Двигайте позлунок чтобы изменить позицию Х' .. getDefaultStr('x', 'target'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 107
        ...
        y = {
            type = 'range',
            name = 'Позиция Y',
            desc = 'Двигайте позлунок чтобы изменить позицию Y' .. getDefaultStr('y', 'target'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 108
...
local optionsFocus = {
    ...
    args = {
        ...
        anchor = {
            type = 'select',
            name = 'Якорь',
            desc = '' .. getDefaultStr('anchor', 'focus'),
            values = {
                ['TOP'] = 'TOP',
                ['RIGHT'] = 'RIGHT',
                ['BOTTOM'] = 'BOTTOM',
        ...
        anchorParent = {
            type = 'select',
            name = 'Главный якорь',
            desc = '' .. getDefaultStr('anchorParent', 'focus'),
            values = {
                ['TOP'] = 'TOP',
                ['RIGHT'] = 'RIGHT',
                ['BOTTOM'] = 'BOTTOM',
        ...
        x = {
            type = 'range',
            name = 'Позиция X',
            desc = 'Двигайте позлунок чтобы изменить позицию Х' .. getDefaultStr('x', 'focus'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 107
        ...
        y = {
            type = 'range',
            name = 'Позиция Y',
            desc = 'Двигайте позлунок чтобы изменить позицию Y' .. getDefaultStr('y', 'focus'),
            min = -2500,
            max = 2500,
            bigStep = 0.50,
            order = 108
...
local options = {
    ...
    args = {
        ...
        reload = {
            type = 'execute',
            name = 'Перезагрузить',
            desc = 'Перезагрузить пользовательский интерфейс',
            func = function()
                ReloadUI()
            end,
            order = 1.1
        ...
        defaults = {
            type = 'execute',
            name = 'Сброс',
            desc = 'Сброс до заводских значений',
...
function Module.CreatePlayerFrameTextures()
    local base = 'Interface\\AddOns\\UI_Reborn\\Textures\\uiunitframe'
    ...
    if not frame.PlayerFrameBackground then
        ...
        background:SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-Player-PortraitOn-BACKGROUND'
        )
    ...
    if not frame.PlayerFrameBorder then
        ...
        border:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-Player-PortraitOn-BORDER')
        ...
        function(self)
            if Module.db.profile.player.classcolor then
                PlayerFrameHealthBar:GetStatusBarTexture():SetTexture(
                    'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Health-Status'
                )
                ...
                PlayerFrameHealthBar:GetStatusBarTexture():SetTexture(
                    'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Health'
                )
        ...
        function(self)
            if Module.db.profile.target.classcolor and UnitIsPlayer('target') then
                TargetFrameHealthBar:GetStatusBarTexture():SetTexture(
                    'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Health-Status'
                )
                ...
                TargetFrameHealthBar:GetStatusBarTexture():SetTexture(
                    'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Health'
                )
...
function Module.ChangePlayerframe()
    ...
    PlayerFrameFlash:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-InCombat')
    ...
    if powerTypeString == 'MANA' then
        PlayerFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Mana'
        )
    elseif powerTypeString == 'RAGE' then
        PlayerFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Rage'
        )
    elseif powerTypeString == 'FOCUS' then
        PlayerFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Focus'
        )
    elseif powerTypeString == 'ENERGY' then
        PlayerFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-Energy'
        )
    elseif powerTypeString == 'RUNIC_POWER' then
        PlayerFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOn-Bar-RunicPower'
        )
    end
...
function Module.ApplyRunesTextures()
    for i = 1, 6 do
        ...
        if rune.runeType == 1 then
            rune:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Runes\\UI-PlayerFrame-Deathknight-Blood')
        elseif rune.runeType == 2 then
            rune:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Runes\\UI-PlayerFrame-Deathknight-Unholy')
        elseif rune.runeType == 3 then
            rune:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Runes\\UI-PlayerFrame-Deathknight-Frost')
        elseif rune.runeType == 4 then
            rune:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Runes\\UI-PlayerFrame-Deathknight-Death')
        end
       _G['RuneButtonIndividual' .. i]:SetScale(0.9)
       _G['RuneButtonIndividual' .. i .. 'Border']:SetScale(1.05)
       _G['RuneButtonIndividual' .. i .. 'BorderTexture']:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\Runes\\UI-PlayerFrame-Deathknight-Ring')
...
function Module.ChangeTargetFrame()
    ...
    if not frame.TargetFrameBackground then
        ...
        background:SetDrawLayer('BACKGROUND', 2)
        background:SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn-BACKGROUND'
        )
    ...
    if not frame.TargetFrameBorder then
        ...
        border:SetDrawLayer('OVERLAY', 2)
        border:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn-BORDER')
    ...
    if not frame.TargetFrameFlash then
        ...
        flash:SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-InCombat'
        )
    ...
    if not frame.PortraitExtra then
        ...
        extra:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\uiunitframeboss2x')
    ...
    if powerTypeString == 'MANA' then
        if not UnitHasMana or not UnitHasMana('target') then
            ...
            TargetFrameManaBar:GetStatusBarTexture():SetTexture(
                'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Mana'
            )
        end
    elseif powerTypeString == 'FOCUS' then
        TargetFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Focus'
        )
    elseif powerTypeString == 'RAGE' then
        TargetFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Rage'
        )
    elseif powerTypeString == 'ENERGY' then
        TargetFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-Energy'
        )
    elseif powerTypeString == 'RUNIC_POWER' then
        TargetFrameManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Target-PortraitOn-Bar-RunicPower'
        )
    end
    ...
    if powerTypeString == 'MANA' then
        if not UnitHasMana or not UnitHasMana('playertargettarget') then
            ...
            frame.ToTManaBar:GetStatusBarTexture():SetTexture(
                'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-Mana'
            )
        end
    elseif powerTypeString == 'FOCUS' then
        frame.ToTManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-Focus'
        )
    elseif powerTypeString == 'RAGE' then
        frame.ToTManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-Rage'
        )
    elseif powerTypeString == 'ENERGY' then
        frame.ToTManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-Energy'
        )
    elseif powerTypeString == 'RUNIC_POWER' then
        frame.ToTManaBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-RunicPower'
        )
    end
...
function Module.ChangeToT()
    ...
    if not frame.TargetFrameToTBackground then
        ...
        background:SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-BACKGROUND'
        )
    ...
    if not frame.TargetFrameToTBorder then
        ...
        border:SetDrawLayer('OVERLAY', 2)
        border:SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-BORDER'
        )
...
function Module.ReApplyToT()
    if UnitExists('playertargettarget') then
        ...
        TargetFrameToTHealthBar:GetStatusBarTexture():SetTexture(
            'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-TargetofTarget-PortraitOn-Bar-Health'
        )
...
function Module.ChangeFocusFrame()
    ...
    --[[    FocusFrameHealthBar:GetStatusBarTexture():SetTexture(
        'Interface\\AddOns\\UI_Reborn\\Textures\\Unitframe\\UI-HUD-UnitFrame-Player-PortraitOff-Bar-Health'
    )
    FocusFrameHealthBar:SetStatusBarColor(1, 1, 1, 1) ]]
    -- Mana 119,12
...
function Module.CreateRestFlipbook()
    if not frame.RestIcon then
        ...
        restTexture:SetTexture('Interface\\AddOns\\UI_Reborn\\Textures\\uiunitframerestingflipbook')
